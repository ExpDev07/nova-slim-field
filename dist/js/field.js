...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-slim-field', __webpack_require__(3));
  Vue.component('detail-slim-field', __webpack_require__(6));
  Vue.component('form-slim-field', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("p", [
    _vm.field.previewUrl
      ? _c("img", {
          staticClass: "align-bottom rounded w-9 h-9",
          staticStyle: { "object-fit": "cover" },
          attrs: { src: _vm.field.previewUrl, alt: _vm.field.helpText }
        })
      : _c("span", [_vm._v("—")])
  ])
}
    ...
    [
      _c("template", { slot: "value" }, [
        _c("div", { staticClass: "w-1/2" }, [
          _vm.field.previewUrl
            ? _c("img", {
                staticClass: "align-bottom rounded",
                staticStyle: { "object-fit": "cover" },
                attrs: { src: _vm.field.previewUrl, alt: _vm.field.helpText }
              })
            : _c("span", [_vm._v("—")])
...
// module
exports.push([module.i, "\n.slim[data-state=\"empty\"][data-v-c023248a] {\n  max-height: 250px;\n  height: 100%;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    dataUrlToFile: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(dataUrl, fileName, type) {
        var res, blob;
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                blob = _context.sent;
                return _context.abrupt('return', new File([blob], fileName, { type: type }));
      ...
      function dataUrlToFile(_x, _x2, _x3) {
          ...
          return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.next = 2;
                  return _this.dataUrlToFile(output.image, output.name, output.type);

                case 2:
                  _this.image = _context2.sent;

                  _this.imageName = output.name;
                  _this.imageRemoved = false;
          ...
          return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  _context3.next = 2;
                  return Nova.request().delete('/nova-api/' + _this.resourceName + '/' + _this.resourceId + '/field/' + _this.field.attribute);

                case 2:
                  _this.$emit('file-deleted');

                  // Update status.
                  _this.image = null;
                  _this.imageName = '';
                  _this.imageRemoved = true;
  ...
  return _c(
    ...
    [
      _c("template", { slot: "field" }, [
        _c("div", { staticClass: "slim", attrs: { id: _vm.fieldId } }, [
          _vm.imageUrl
            ? _c("img", {
                attrs: { src: _vm.imageUrl, alt: _vm.field.helpText }
              })
            : _vm._e(),
          _vm._v(" "),
          _c("input", { ref: "field", attrs: { type: "file", name: "slim[]" } })
        ])
      ])
    ],
    2
